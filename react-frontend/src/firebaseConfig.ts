...
// Export storage and firestore for uploads and metadata
export const storage = getStorage(app); //pull storage
export const firestore = getFirestore(app); //pull firestore database
